...
export default function CreatePost({ currentUser }: { currentUser: CurrentUser }) {
  ...
  const avatar = currentUser.image ?? '/assets/images/txt_img.png';
    ...
    >
      <div className="_feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box_image">
          <Image src={avatar} alt="Profile" width={40} height={40} className="_txt_img" />
        </div>
      ...
      <div style={{ padding: '8px 0 0', display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          {images.map((img, index) => (
            <div key={index} style={{ position: 'relative', display: 'inline-block' }}>
              ...
              <img
                src={img.preview}
                alt={`Preview ${index + 1}`}
                style={{ maxWidth: '100%', borderRadius: '6px', maxHeight: '200px', objectFit: 'cover', width: '140px', height: '140px' }}
              />
              <button
                type="button"
                onClick={() => removeImage(index)}
                style={{ position: 'absolute', top: '4px', right: '4px', background: 'rgba(0,0,0,0.5)', color: '#fff', border: 'none', borderRadius: '50%', width: '24px', height: '24px', cursor: 'pointer', fontSize: '14px', lineHeight: 1 }}
              >
                ×
              </button>
            </div>
      ...
      <div className="_feed_inner_text_area_bottom">
        ...
        <div className="_feed_inner_text_area_btn">
          <button type="submit" disabled={submitting || !text.trim()} className="_feed_inner_text_area_btn_link">
