      ...
      <div className="container _custom_container">
        <div className="_logo_wrap">
          <Link className="navbar-brand" href="/feed">
            <Image src="/assets/images/logo.svg" alt="Image" width={120} height={36} className="_nav_logo" />
          </Link>
        </div>
        ...
        <div className="navbar-collapse" id="navbarSupportedContent" style={{ display: 'flex', flexBasis: 'auto', alignItems: 'center' }}>
          {/* Search */}
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li ref={notifyRef} className="nav-item _header_nav_item" style={{ position: 'relative' }}>
              <span
                ...
                onClick={() => { setShowNotify(prev => !prev); setShowProfile(false); }}
              >
          ...
          <div ref={profileRef} className="_header_nav_profile" style={{ position: 'relative' }}>
            <div className="_header_nav_profile_image">
              <Image src="/assets/images/profile.png" alt="Image" width={36} height={36} className="_nav_profile_img" />
            </div>
            <div className="_header_nav_dropdown">
              ...
              <button
                ...
                type="button"
                onClick={() => { setShowProfile(prev => !prev); setShowNotify(false); }}
              >
            ...
            <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown${showProfile ? ' show' : ''}`}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <Image src="/assets/images/profile.png" alt="Image" width={48} height={48} className="_nav_drop_img" />
                  </div>
                ...
                <ul className="_nav_dropdown_list">
                  ...
                  <li className="_nav_dropdown_list_item">
                    <Link href="/auth/login" className="_nav_dropdown_link">
                      <div className="_nav_drop_info">
                        <span>
