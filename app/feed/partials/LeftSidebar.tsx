...
const events = [
  { id: 1, image: '/assets/images/feed_event1.png', day: '10', month: 'Jul', title: 'No more terrorism no more cry', going: 17 },
  { id: 2, image: '/assets/images/feed_event1.png', day: '10', month: 'Jul', title: 'No more terrorism no more cry', going: 17 },
];
      ...
      <div className="_layout_left_sidebar_wrap">
          ...
          <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            <ul className="_left_inner_area_explore_list">
              {exploreLinks.map((item) => (
                <li key={item.label} className={`_left_inner_area_explore_item${item.badge ? ' _explore_item' : ''}`}>
                  <Link href={item.href} className="_left_inner_area_explore_link">
                    {item.icon}
                    {item.label}
                  </Link>
              ...
              <div key={person.id} className="_left_inner_area_suggest_info">
                <div className="_left_inner_area_suggest_info_box">
                  <div className="_left_inner_area_suggest_info_image">
                    <Link href="/profile">
                      <Image src={person.image} alt={person.name} width={44} height={44} className="_info_img" />
                    </Link>
                  </div>
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            {events.map((event) => (
              <div key={event.id} className="_left_inner_event_card">
                <Link className="_left_inner_event_card_link" href="/event">
                  <div className="_left_inner_event_card_iamge">
                    <Image src={event.image} alt={event.title} width={300} height={120} className="_card_img" />
                  </div>
