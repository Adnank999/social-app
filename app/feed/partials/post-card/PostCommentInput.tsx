...
export default function PostCommentInput({ value, loading, onChange, onSubmit }: Props) {
  return (
        ...
        <form className="_feed_inner_comment_box_form" onSubmit={onSubmit}>
          <div className="_feed_inner_comment_box_content">
            <div className="_feed_inner_comment_box_content_image">
              <Image src="/assets/images/comment_img.png" alt="" width={26} height={26} className="_comment_img" />
            </div>
          ...
          <div className="_feed_inner_comment_box_icon">
            <button type="submit" className="_feed_inner_comment_box_icon_btn" disabled={loading || !value.trim()}>
